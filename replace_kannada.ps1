# PowerShell script to replace corrupted Kannada section with proper translations
...
# The section starts with "kn: {" and ends with the closing brace before "ar:"
$pattern = '(?s)(kn:\s*\{)(.*?)(\},\s*ar:)'

# The new Kannada translations (properly encoded)
$newKannada = @'
kn: {
        nav_home: "ಮುಖಪುಟ",
        ...
        hero_description: "ನವಭಾರತ್ ಟೆಕ್ನಾಲಜೀಸ್ ಮೈಸೂರು ಮೂಲದ ಸಾಫ್ಟ್‌ವೇರ್ ಕಂಪನಿಯಾಗಿದ್ದು, ವ್ಯವಹಾರಗಳು ಡಿಜಿಟಲ್-ಮೊದಲ ಜಗತ್ತಿನಲ್ಲಿ ಹೊಂದಿಕೊಳ್ಳಲು, ಬೆಳೆಯಲು ಮತ್ತು ಸುರಕ್ಷಿತವಾಗಿರಲು ಸಹಾಯ ಮಾಡುವತ್ತ ಗಮನಹರಿಸಿದೆ.",
        hero_cta: "ಪ್ರಾರಂಭಿಸಿ",
        about_title: "ನಮ್ಮ ಬಗ್ಗೆ",
        about_description: "ನವಭಾರತ್ ಟೆಕ್ನಾಲಜೀಸ್ ನವೀನ ಮತ್ತು ದೃಢವಾದ ಡಿಜಿಟಲ್ ಉತ್ಪನ್ನಗಳನ್ನು ತಲುಪಿಸಲು ಸಮರ್ಪಿತವಾದ ಪ್ರಮುಖ IT ಪರಿಹಾರ ಪೂರೈಕೆದಾರರಾಗಿದ್ದಾರೆ.",
...
# Replace the corrupted Kannada section
$newContent = $content -replace $pattern, $newKannada + '$3'

# Save with UTF-8 encoding (no BOM)
$utf8NoBom = New-Object System.Text.UTF8Encoding $false
[System.IO.File]::WriteAllText($scriptPath, $newContent, $utf8NoBom)

Write-Host "Successfully replaced Kannada translations with proper UTF-8 encoding!"
Write-Host "Please refresh your browser and test the Kannada language now."
