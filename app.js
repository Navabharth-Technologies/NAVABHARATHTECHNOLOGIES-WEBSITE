...
const translations = {
    ...
    es: {
        ...
        service5_description: "Implementación de estrategias de marketing inteligentes para impulsar su presencia en línea.",
        service6_title: "Soluciones IVR",
        service6_description: "Sistemas avanzados de Respuesta de Voz Interactiva para automatizar las interacciones con los clientes y agilizar la gestión de llamadas con menús de voz inteligentes.",
        service7_title: "Soluciones de IA",
        service7_description: "Soluciones de inteligencia artificial y aprendizaje automático de vanguardia para automatizar procesos, mejorar la toma de decisiones y desbloquear conocimientos basados en datos para su negocio.",

        // Why Choose Us Section
        why_choose_title: "¿Por qué elegir Navabharath Technologies?",
        why_feature1_title: "Soluciones Preparadas para el Futuro",
        why_feature1_desc: "Construyendo cimientos digitales duraderos.",
        why_feature2_title: "Altos Estándares de Seguridad",
        why_feature2_desc: "Garantizando datos seguros y protegidos.",
        why_feature3_title: "Desarrollo de Extremo a Extremo",
        why_feature3_desc: "Desde la investigación hasta el despliegue y soporte.",
        ...
        why_feature5_desc: "Soporte dedicado y comunicación transparente.",
        ...
        explore_banner_desc: "Descubra nuestro viaje, misión y visión",
        explore_intro_title: "Navabharath Technologies — Impulsando el Crecimiento a través de Soluciones de TI Inteligentes",
        explore_intro_desc: "Navabharath Technologies es una empresa de soluciones de TI con visión de futuro que ofrece servicios digitales inteligentes, escalables y orientados a resultados. Con un fuerte enfoque en la innovación y el diseño centrado en el cliente, ayudamos a las empresas a transformarse, automatizar y crecer en el mundo digital de rápida evolución actual. Respaldados por un equipo experimentado y tecnologías modernas, garantizamos una ejecución perfecta, flujos de trabajo optimizados y una entrega de alta calidad. Nuestra dedicación a la excelencia, la transparencia y la confiabilidad nos convierte en un socio de confianza para empresas de todos los tamaños.",
        explore_what_do_title: "Lo Que Hacemos",
        explore_what_do_1: "Construcción de sitios web personalizados, aplicaciones y productos digitales diseñados para un rendimiento a largo plazo.",
        explore_what_do_2: "Estrategias y tecnologías inteligentes que coinciden con sus objetivos y flujo de trabajo.",
        explore_what_do_3: "Sistemas digitales robustos, fiables y optimizados para una máxima eficiencia.",
        explore_what_do_4: "Soluciones diseñadas teniendo en cuenta la usabilidad, la experiencia y el impacto empresarial.",
        explore_mission_title: "Nuestra Misión",
        explore_mission_p1: "Nuestra misión es empoderar a las empresas con soluciones digitales avanzadas que aceleren el crecimiento y fortalezcan su ventaja competitiva. Nos centramos en mejorar la eficiencia operativa a través de tecnologías inteligentes, automatizadas y escalables que agilizan cada flujo de trabajo. Al ofrecer experiencias digitales de alta calidad, garantizamos el éxito a largo plazo y el desarrollo sostenible para nuestros clientes. Innovamos y nos adaptamos continuamente a las necesidades cambiantes de la industria para ofrecer soluciones modernas y preparadas para el futuro. A través de nuestro compromiso con la excelencia, nos esforzamos por crear un valor significativo y ayudar a las empresas a operar de manera más inteligente, rápida y eficiente.",
        explore_vision_title: "Nuestra Visión",
        explore_vision_p1: "Nuestra visión es ser un líder mundial en transformación digital, reconocido por nuestra capacidad para convertir desafíos complejos en soluciones tecnológicas simples y efectivas. Aspiramos a construir un futuro donde cada empresa, independientemente de su tamaño, tenga acceso a las herramientas que necesita para prosperar en una economía digital primero. Al fomentar una cultura de creatividad, integridad y colaboración, nuestro objetivo es establecer nuevos estándares en la industria de TI. Nos vemos como catalizadores del cambio, impulsando el progreso y la innovación que no solo benefician a nuestros clientes, sino que también contribuyen a un mundo más conectado y eficiente.",
        explore_values_title: "Lo Que Hacemos",
        explore_what_we_do_p1: "Nos especializamos en una amplia gama de servicios de TI diseñados para satisfacer las diversas necesidades de las empresas modernas. Desde el desarrollo de software personalizado y la creación de aplicaciones móviles hasta la computación en la nube y el análisis de datos, ofrecemos soluciones integrales que impulsan resultados. Nuestro equipo de expertos trabaja en estrecha colaboración con los clientes para comprender sus desafíos y objetivos únicos, ofreciendo estrategias personalizadas que maximizan el ROI. Ya sea que necesite modernizar sistemas heredados, construir un nuevo producto digital desde cero u optimizar su infraestructura existente, tenemos la experiencia y la experiencia para ayudarlo a tener éxito.",
        explore_trust_title: "Por Qué Las Empresas Confían En Nosotros",
        explore_trust_1_title: "1. Enfoque Impulsado por la Innovación",
        explore_trust_1_desc: "Utilizamos herramientas modernas y mejores prácticas para ofrecer soluciones preparadas para el futuro.",
        explore_trust_2_title: "2. Ejecución Centrada en el Cliente",
        ...
        explore_trust_4_desc: "Comunicación clara, procesos fiables y entrega oportuna en cada etapa.",
    ...
    fr: {
        ...
        service5_title: "Marketing Numérique",
        service5_description: "Mise en Å“uvre de stratégies marketing intelligentes pour booster votre présence en ligne.",
        service6_title: "Solutions SVI",
        service6_description: "Systèmes de Réponse Vocale Interactive avancés pour automatiser les interactions clients et rationaliser la gestion des appels avec des menus vocaux intelligents.",
        service7_title: "Solutions IA",
        service7_description: "Solutions d'intelligence artificielle et d'apprentissage automatique de pointe pour automatiser les processus, améliorer la prise de décision et débloquer des informations basées sur les données pour votre entreprise.",

        // Why Choose Us Section
        why_choose_title: "Pourquoi choisir Navabharath Technologies ?",
        why_feature1_title: "Solutions prêtes pour l'avenir",
        why_feature1_desc: "Construire des fondations numériques durables.",
        why_feature2_title: "Normes de sécurité élevées",
        why_feature2_desc: "Assurer la sécurité et la protection des données.",
        why_feature3_title: "Développement de bout en bout",
        why_feature3_desc: "De la recherche au déploiement et au support.",
        why_feature4_title: "Approche axée sur les résultats",
        why_feature4_desc: "Nous nous concentrons sur la performance, la vitesse et la convivialité.",
        why_feature5_title: "Équipe centrée sur le client",
        why_feature5_desc: "Support dédié et communication transparente.",
        why_feature6_title: "Services DevOps",
        why_feature6_desc: "Infrastructure sécurisée, évolutive et fiable.",
        ...
        footer_copyright: "\u00A9 2026 Navabharath Technologies. Tous droits réservés.",

        // Explore Page
        explore_banner_title: "Explorer",
        explore_banner_desc: "Découvrez notre parcours, notre mission et notre vision",
        explore_intro_title: "Navabharath Technologies — Favoriser la croissance grâce à des solutions informatiques intelligentes",
        explore_intro_desc: "Navabharath Technologies est une société de solutions informatiques avant-gardiste qui fournit des services numériques intelligents, évolutifs et axés sur les résultats. Avec un fort accent sur l'innovation et la conception centrée sur le client, nous aidons les entreprises à se transformer, à s'automatiser et à se développer dans le monde numérique en évolution rapide d'aujourd'hui. Soutenus par une équipe expérimentée et des technologies modernes, nous assurons une exécution transparente, des flux de travail optimisés et une livraison de haute qualité. Notre dévouement à l'excellence, à la transparence et à la fiabilité fait de nous un partenaire de confiance pour les entreprises de toutes tailles.",
        explore_what_do_title: "Ce Que Nous Faisons",
        explore_what_do_1: "Création de sites Web personnalisés, d'applications et de produits numériques conçus pour des performances à long terme.",
        explore_what_do_2: "Des stratégies et des technologies intelligentes qui correspondent à vos objectifs et à votre flux de travail.",
        explore_what_do_3: "Des systèmes numériques robustes, fiables et optimisés pour une efficacité maximale.",
        explore_what_do_4: "Des solutions conçues en tenant compte de la convivialité, de l'expérience et de l'impact commercial.",
        explore_mission_title: "Notre Mission",
        explore_mission_p1: "Notre mission est de donner aux entreprises les moyens de disposer de solutions numériques avancées qui accélèrent la croissance et renforcent leur avantage concurrentiel. Nous nous concentrons sur l'amélioration de l'efficacité opérationnelle grâce à des technologies intelligentes, automatisées et évolutives qui rationalisent chaque flux de travail. En offrant des expériences numériques de haute qualité, nous assurons le succès à long terme et le développement durable de nos clients. Nous innovons et nous adaptons continuellement aux besoins changeants de l'industrie pour fournir des solutions modernes et prêtes pour l'avenir. Grâce à notre engagement envers l'excellence, nous nous efforçons de créer une valeur significative et d'aider les entreprises à fonctionner plus intelligemment, plus rapidement et plus efficacement.",
        explore_vision_title: "Notre Vision",
        explore_vision_p1: "Notre vision est d'être un leader mondial de la transformation numérique, reconnu pour notre capacité à transformer des défis complexes en solutions technologiques simples et efficaces. Nous aspirons à bâtir un avenir où chaque entreprise, quelle que soit sa taille, a accès aux outils dont elle a besoin pour prospérer dans une économie numérique. En favorisant une culture de créativité, d'intégrité et de collaboration, nous visons à établir de nouvelles normes dans l'industrie informatique. Nous nous considérons comme des catalyseurs de changement, favorisant le progrès et l'innovation qui profitent non seulement à nos clients, mais contribuent également à un monde plus connecté et plus efficace.",
        explore_values_title: "Ce Que Nous Faisons",
        explore_what_we_do_p1: "Nous nous spécialisons dans une large gamme de services informatiques conçus pour répondre aux divers besoins des entreprises modernes. Du développement de logiciels personnalisés et de la création d'applications mobiles au cloud computing et à l'analyse de données, nous proposons des solutions de bout en bout qui génèrent des résultats. Notre équipe d'experts travaille en étroite collaboration avec les clients pour comprendre leurs défis et objectifs uniques, en proposant des stratégies sur mesure qui maximisent le retour sur investissement. Que vous ayez besoin de moderniser des systèmes existants, de créer un nouveau produit numérique à partir de zéro ou d'optimiser votre infrastructure existante, nous avons l'expertise et l'expérience pour vous aider à réussir.",
        explore_trust_title: "Pourquoi Les Entreprises Nous Font Confiance",
        explore_trust_1_title: "1. Approche Axée sur l'Innovation",
        explore_trust_1_desc: "Nous utilisons des outils modernes et les meilleures pratiques pour fournir des solutions prêtes pour l'avenir.",
        explore_trust_2_title: "2. Exécution Centrée sur le Client",
        explore_trust_2_desc: "Chaque projet est personnalisé en fonction de vos objectifs commerciaux et de vos flux de travail.",
        explore_trust_3_title: "3. Professionnels Qualifiés",
        explore_trust_3_desc: "Une équipe qui allie créativité, expertise et connaissance de l'industrie.",
        explore_trust_4_title: "4. Qualité et Transparence",
        explore_trust_4_desc: "Une communication claire, des processus fiables et une livraison rapide à chaque étape.",
    ...
    de: {
        ...
        service5_description: "Implementierung intelligenter Marketingstrategien zur Steigerung Ihrer Online-Präsenz.",
        service6_title: "IVR-Lösungen",
        service6_description: "Fortschrittliche interaktive Sprachantwortsysteme zur Automatisierung von Kundeninteraktionen und Rationalisierung des Anrufsmanagements mit intelligenten Sprachmenüs.",
        service7_title: "KI-Lösungen",
        service7_description: "Hochmoderne Lösungen für künstliche Intelligenz und maschinelles Lernen zur Automatisierung von Prozessen, Verbesserung der Entscheidungsfindung und Erschließung datengesteuerter Erkenntnisse für Ihr Unternehmen.",

        // Why Choose Us Section
        why_choose_title: "Warum Navabharath Technologies wählen?",
        why_feature1_title: "Zukunftsfähige Lösungen",
        why_feature1_desc: "Aufbau dauerhafter digitaler Grundlagen.",
        why_feature2_title: "Hohe Sicherheitsstandards",
        why_feature2_desc: "Gewährleistung sicherer und geschützter Daten.",
        why_feature3_title: "End-to-End-Entwicklung",
        why_feature3_desc: "Von der Forschung bis zur Bereitstellung und Unterstützung.",
        ...
        why_feature6_desc: "Sichere, skalierbare und zuverlässige Infrastruktur.",
        ...
        explore_intro_title: "Navabharath Technologies — Wachstum durch intelligente IT-Lösungen fördern",
        explore_intro_desc: "Navabharath Technologies ist ein zukunftsorientiertes IT-Lösungsunternehmen, das intelligente, skalierbare und ergebnisorientierte digitale Dienste anbietet. Mit einem starken Fokus auf Innovation und kundenorientiertes Design helfen wir Unternehmen, sich in der heutigen schnelllebigen digitalen Welt zu verändern, zu automatisieren und zu wachsen. Unterstützt von einem erfahrenen Team und modernen Technologien gewährleisten wir eine nahtlose Ausführung, optimierte Arbeitsabläufe und eine qualitativ hochwertige Lieferung. Unser Engagement für Exzellenz, Transparenz und Zuverlässigkeit macht uns zu einem vertrauenswürdigen Partner für Unternehmen jeder Größe.",
        explore_what_do_title: "Was Wir Tun",
        explore_what_do_1: "Erstellung maßgeschneiderter Websites, Anwendungen und digitaler Produkte, die auf langfristige Leistung ausgelegt sind.",
        explore_what_do_2: "Intelligente Strategien und Technologien, die Ihren Zielen und Arbeitsabläufen entsprechen.",
        explore_what_do_3: "Robuste, zuverlässige und optimierte digitale Systeme für maximale Effizienz.",
        explore_what_do_4: "Lösungen, die im Hinblick auf Benutzerfreundlichkeit, Erfahrung und geschäftliche Auswirkungen entwickelt wurden.",
        explore_mission_title: "Unsere Mission",
        explore_mission_p1: "Unsere Mission ist es, Unternehmen mit fortschrittlichen digitalen Lösungen zu stärken, die das Wachstum beschleunigen und ihren Wettbewerbsvorteil stärken. Wir konzentrieren uns auf die Verbesserung der betrieblichen Effizienz durch intelligente, automatisierte und skalierbare Technologien, die jeden Arbeitsablauf rationalisieren. Durch die Bereitstellung hochwertiger digitaler Erlebnisse stellen wir den langfristigen Erfolg und die nachhaltige Entwicklung unserer Kunden sicher. Wir innovieren ständig und passen uns den sich entwickelnden Branchenanforderungen an, um moderne, zukunftsfähige Lösungen zu liefern. Durch unser Engagement für Exzellenz streben wir danach, sinnvollen Wert zu schaffen und Unternehmen dabei zu helfen, intelligenter, schneller und effizienter zu arbeiten.",
        explore_vision_title: "Unsere Vision",
        explore_vision_p1: "Unsere Vision ist es, ein weltweit führender Anbieter von digitaler Transformation zu sein, der für seine Fähigkeit bekannt ist, komplexe Herausforderungen in einfache, effektive technologische Lösungen umzuwandeln. Wir streben danach, eine Zukunft aufzubauen, in der jedes Unternehmen, unabhängig von seiner Größe, Zugang zu den Tools hat, die es benötigt, um in einer digitalen Wirtschaft erfolgreich zu sein. Durch die Förderung einer Kultur der Kreativität, Integrität und Zusammenarbeit wollen wir neue Standards in der IT-Branche setzen. Wir sehen uns als Katalysatoren für Veränderungen, die Fortschritt und Innovation vorantreiben, die nicht nur unseren Kunden zugutekommen, sondern auch zu einer vernetzteren und effizienteren Welt beitragen.",
        explore_values_title: "Was Wir Tun",
        explore_what_we_do_p1: "Wir sind auf eine breite Palette von IT-Dienstleistungen spezialisiert, die auf die unterschiedlichen Bedürfnisse moderner Unternehmen zugeschnitten sind. Von der Entwicklung kundenspezifischer Software und der Erstellung mobiler Apps bis hin zu Cloud Computing und Datenanalyse bieten wir End-to-End-Lösungen, die Ergebnisse liefern. Unser Expertenteam arbeitet eng mit Kunden zusammen, um ihre einzigartigen Herausforderungen und Ziele zu verstehen und maßgeschneiderte Strategien zu liefern, die den ROI maximieren. Egal, ob Sie Legacy-Systeme modernisieren, ein neues digitales Produkt von Grund auf neu erstellen oder Ihre bestehende Infrastruktur optimieren müssen, wir verfügen über das Fachwissen und die Erfahrung, um Ihnen zum Erfolg zu verhelfen.",
        explore_trust_title: "Warum Unternehmen uns vertrauen",
        explore_trust_1_title: "1. Innovationsgetriebener Ansatz",
        explore_trust_1_desc: "Wir verwenden moderne Tools und Best Practices, um zukunftsfähige Lösungen zu liefern.",
        explore_trust_2_title: "2. Kundenorientierte Ausführung",
        explore_trust_2_desc: "Jedes Projekt ist auf Ihre Geschäftsziele und Arbeitsabläufe zugeschnitten.",
        explore_trust_3_title: "3. Qualifizierte Fachleute",
        explore_trust_3_desc: "Ein Team, das Kreativität, Fachwissen und Branchenkenntnisse vereint.",
        explore_trust_4_title: "4. Qualität und Transparenz",
        explore_trust_4_desc: "Klare Kommunikation, zuverlässige Prozesse und pünktliche Lieferung in jeder Phase.",
    ...
    it: {
        ...
        // Why Choose Us Section
        why_choose_title: "Perché Scegliere Navabharath Technologies?",
        ...
        why_feature4_desc: "Ci concentriamo su prestazioni, velocità e usabilità.",
        ...
        explore_intro_title: "Navabharath Technologies — Favorire la crescita attraverso soluzioni IT intelligenti",
        explore_intro_desc: "Navabharath Technologies è un'azienda di soluzioni IT lungimirante che fornisce servizi digitali intelligenti, scalabili e orientati ai risultati. Con una forte attenzione all'innovazione e al design centrato sul cliente, aiutiamo le aziende a trasformarsi, automatizzare e crescere nel frenetico mondo digitale di oggi. Supportati da un team di esperti e tecnologie moderne, garantiamo un'esecuzione senza interruzioni, flussi di lavoro ottimizzati e consegne di alta qualità. La nostra dedizione all'eccellenza, trasparenza e affidabilità ci rende un partner fidato per aziende di tutte le dimensioni.",
        ...
        explore_what_do_4: "Soluzioni realizzate pensando all'usabilità, all'esperienza e all'impatto aziendale.",
        explore_mission_title: "La Nostra Missione",
        explore_mission_p1: "La nostra missione è dare potere alle aziende con soluzioni digitali avanzate che accelerano la crescita e rafforzano il loro vantaggio competitivo. Ci concentriamo sul miglioramento dell'efficienza operativa attraverso tecnologie intelligenti, automatizzate e scalabili che semplificano ogni flusso di lavoro. Fornendo esperienze digitali di alta qualità, garantiamo il successo a lungo termine e lo sviluppo sostenibile per i nostri clienti. Innoviamo e ci adattiamo continuamente alle esigenze del settore in evoluzione per fornire soluzioni moderne e pronte per il futuro. Attraverso il nostro impegno per l'eccellenza, ci sforziamo di creare un valore significativo e aiutare le aziende a operare in modo più intelligente, veloce ed efficiente.",
        explore_vision_title: "La Nostra Visione",
        explore_vision_p1: "La nostra visione è quella di essere un leader globale nella trasformazione digitale, riconosciuto per la nostra capacità di trasformare sfide complesse in soluzioni tecnologiche semplici ed efficaci. Aspiriamo a costruire un futuro in cui ogni azienda, indipendentemente dalle dimensioni, abbia accesso agli strumenti di cui ha bisogno per prosperare in un'economia digital-first. Promuovendo una cultura di creatività, integrità e collaborazione, miriamo a stabilire nuovi standard nel settore IT. Ci vediamo come catalizzatori del cambiamento, guidando il progresso e l'innovazione che non solo avvantaggiano i nostri clienti ma contribuiscono anche a un mondo più connesso ed efficiente.",
        ...
        explore_trust_title: "Perché Le Aziende Si Fidano Di Noi",
        ...
        explore_trust_2_desc: "Ogni progetto è personalizzato per i tuoi obiettivi aziendali e flussi di lavoro.",
        explore_trust_3_title: "3. Professionisti Qualificati",
        explore_trust_3_desc: "Un team che unisce creatività, competenza e conoscenza del settore.",
        explore_trust_4_title: "4. Qualità e Trasparenza",
    ...
    pt: {
        ...
        service5_title: "Marketing Digital",
        service5_description: "Implementação de estratégias de marketing inteligentes para impulsionar sua presença online.",
        service6_title: "Soluções IVR",
        service6_description: "Sistemas avançados de Resposta de Voz Interativa para automatizar interações com clientes e otimizar o gerenciamento de chamadas com menus de voz inteligentes.",
        service7_title: "Soluções de IA",
        service7_description: "Soluções de inteligência artificial e aprendizado de máquina de ponta para automatizar processos, aprimorar a tomada de decisões e desbloquear insights baseados em dados para o seu negócio.",

        // Why Choose Us Section
        why_choose_title: "Por que escolher a Navabharath Technologies?",
        why_feature1_title: "Soluções Prontas para o Futuro",
        why_feature1_desc: "Construindo bases digitais duradouras.",
        why_feature2_title: "Altos Padrões de Segurança",
        why_feature2_desc: "Garantindo dados seguros e protegidos.",
        why_feature3_title: "Desenvolvimento de Ponta a Ponta",
        why_feature3_desc: "Da pesquisa à implantação e suporte.",
        ...
        why_feature5_desc: "Suporte dedicado e comunicação transparente.",
        why_feature6_title: "Serviços DevOps",
        why_feature6_desc: "Infraestrutura segura, escalável e confiável.",
        ...
        // Explore Page
        explore_banner_title: "Explorar",
        explore_banner_desc: "Descubra nossa jornada, missão e visão",
        explore_intro_title: "Navabharath Technologies — Impulsionando o crescimento através de soluções de TI inteligentes",
        explore_intro_desc: "A Navabharath Technologies é uma empresa de soluções de TI com visão de futuro que fornece serviços digitais inteligentes, escaláveis e orientados a resultados. Com um forte foco em inovação e design centrado no cliente, ajudamos as empresas a transformar, automatizar e crescer no mundo digital em rápida evolução de hoje. Apoiados por uma equipe experiente e tecnologias modernas, garantimos execução perfeita, fluxos de trabalho otimizados e entrega de alta qualidade. Nossa dedicação à excelência, transparência e confiabilidade nos torna um parceiro de confiança para empresas de todos os tamanhos.",
        explore_what_do_title: "O Que Fazemos",
        explore_what_do_1: "Construção de sites personalizados, aplicativos e produtos digitais projetados para desempenho de longo prazo.",
        explore_what_do_2: "Estratégias e tecnologias inteligentes que correspondem aos seus objetivos e fluxo de trabalho.",
        explore_what_do_3: "Sistemas digitais robustos, confiáveis e otimizados para máxima eficiência.",
        explore_what_do_4: "Soluções criadas com usabilidade, experiência e impacto nos negócios em mente.",
        explore_mission_title: "Nossa Missão",
        explore_mission_p1: "Nossa missão é capacitar empresas com soluções digitais avançadas que aceleram o crescimento e fortalecem sua vantagem competitiva. Nós nos concentramos em melhorar a eficiência operacional por meio de tecnologias inteligentes, automatizadas e escaláveis que agilizam cada fluxo de trabalho. Ao oferecer experiências digitais de alta qualidade, garantimos sucesso a longo prazo e desenvolvimento sustentável para nossos clientes. Inovamos e nos adaptamos continuamente às necessidades em evolução da indústria para fornecer soluções modernas e prontas para o futuro. Através do nosso compromisso com a excelência, nos esforçamos para criar valor significativo e ajudar as empresas a operar de forma mais inteligente, rápida e eficiente.",
        explore_vision_title: "Nossa Visão",
        explore_vision_p1: "Nossa visão é ser um líder global em transformação digital, reconhecido por nossa capacidade de transformar desafios complexos em soluções tecnológicas simples e eficazes. Aspiramos construir um futuro onde cada empresa, independentemente do tamanho, tenha acesso às ferramentas de que precisa para prosperar em uma economia digital em primeiro lugar. Ao promover uma cultura de criatividade, integridade e colaboração, pretendemos estabelecer novos padrões na indústria de TI. Vemos a nós mesmos como catalisadores de mudança, impulsionando o progresso e a inovação que não apenas beneficiam nossos clientes, mas também contribuem para um mundo mais conectado e eficiente.",
        explore_values_title: "O Que Fazemos",
        explore_what_we_do_p1: "Somos especializados em uma ampla gama de serviços de TI projetados para atender às diversas necessidades das empresas modernas. Desde o desenvolvimento de software personalizado e a criação de aplicativos móveis até computação em nuvem e análise de dados, oferecemos soluções de ponta a ponta que geram resultados. Nossa equipe de especialistas trabalha em estreita colaboração com os clientes para entender seus desafios e objetivos únicos, fornecendo estratégias personalizadas que maximizam o ROI. Se você precisa modernizar sistemas legados, construir um novo produto digital do zero ou otimizar sua infraestrutura existente, temos a experiência e a experiência para ajudá-lo a ter sucesso.",
        explore_trust_title: "Por Que As Empresas Confiam Em Nós",
        explore_trust_1_title: "1. Abordagem Impulsionada pela Inovação",
        explore_trust_1_desc: "Utilizamos ferramentas modernas e melhores práticas para fornecer soluções prontas para o futuro.",
        explore_trust_2_title: "2. Execução Centrada no Cliente",
        explore_trust_2_desc: "Cada projeto é personalizado para seus objetivos de negócios e fluxos de trabalho.",
        explore_trust_3_title: "3. Profissionais Qualificados",
        explore_trust_3_desc: "Uma equipe que combina criatividade, experiência e conhecimento do setor.",
        explore_trust_4_title: "4. Qualidade e Transparência",
        explore_trust_4_desc: "Comunicação clara, processos confiáveis e entrega pontual em cada estágio.",
    ...
    ar: {
        ...
        about_explore: "استكشف",

        // Hero Section
        hero_title: "حلول أذكى لمستقبل أفضل",
        hero_subtitle: "تطوير الويب | تطبيقات الجوال | تحسين محركات البحث | التسويق الرقمي",
        hero_description: "نافابهاراث تكنولوجيز هي شركة برمجيات مقرها ميسور تركز على مساعدة الشركات على التكيف والنمو والبقاء آمنة في عالم رقمي أولاً. نحن نصمم حلول تقنية المعلومات العملية التي تبسط العمليات اليومية، وتعزز بنية النظام، وتحمي بيانات الأعمال الحيوية، وتدعم النمو المستمر طويل الأجل من خلال التقنيات الحديثة والجاهزة للمستقبل.",
        hero_cta: "ابدأ الآن",

        // About Section
        about_title: "من نحن",
        about_description: "نافابهاراث تكنولوجيز هي مزود رائد لحلول تقنية المعلومات مكرس لتقديم منتجات رقمية مبتكرة وقوية. مع فريق من المطورين والمصممين الخبراء، نحول الأفكار إلى واقع. مهمتنا هي تمكين الشركات بتقنية قابلة للتوسع وفعالة وخدمات شاملة من البداية إلى النهاية.",
        about_feature1: "حلول مبتكرة",
        about_feature2: "التسويق الرقمي",
        about_feature3: "نهج يركز على العملاء",
        about_feature4: "فريق خبراء",
        ...
        service3_description: "إعداد وإدارة البنية التحتية السحابية الآمنة والقابلة للتوسع.",
        ...
        service5_title: "التسويق الرقمي",
        service5_description: "تنفيذ استراتيجيات تسويق ذكية لتعزيز تواجدك على الإنترنت.",
        service6_title: "حلول IVR",
        service6_description: "أنظمة استجابة صوتية تفاعلية متقدمة لأتمتة تفاعلات العملاء وتبسيط إدارة المكالمات بقوائم صوتية ذكية.",
        service7_title: "حلول الذكاء الاصطناعي",
        service7_description: "حلول ذكاء اصطناعي وتعلم آلي متطورة لأتمتة العمليات وتحسين اتخاذ القرارات وفتح رؤى مدفوعة بالبيانات لعملك.",

        // Why Choose Us Section
        why_choose_title: "لماذا تختار نافابهاراث تكنولوجيز؟",
        why_feature1_title: "حلول جاهزة للمستقبل",
        why_feature1_desc: "بناء أسس رقمية دائمة.",
        why_feature2_title: "معايير أمان عالية",
        why_feature2_desc: "ضمان بيانات آمنة ومحمية.",
        why_feature3_title: "تطوير شامل من البداية إلى النهاية",
        why_feature3_desc: "من البحث إلى النشر والدعم.",
        why_feature4_title: "نهج موجه نحو النتائج",
        why_feature4_desc: "نحن نركز على الأداء والسرعة وسهولة الاستخدام.",
        why_feature5_title: "فريق يركز على العملاء",
        why_feature5_desc: "دعم مخصص وتواصل شفاف.",
        why_feature6_title: "خدمات DevOps",
        why_feature6_desc: "بنية تحتية آمنة وقابلة للتوسع وموثوقة.",
        ...
        // Footer
        footer_tagline: "حلول أذكى لمستقبل أفضل",
        ...
        footer_copyright: "\u00A9 2026 نافابهاراث تكنولوجيز. جميع الحقوق محفوظة.",
        footer_careers: "الوظائف",
        footer_join_team: "انضم إلى فريقنا",

        // Clients Section
        clients_title: "عملاؤنا الموثوقون",
        clients_subtitle: "تمكين النمو لقادة الصناعة في جميع أنحاء العالم.",

        // Resources Page
        resources_intro_title: "مركز المعرفة",
        resources_intro_desc: "اكتشف موارد منسقة من قبل الخبراء، وأدلة خطوة بخطوة، ورؤى صناعية مصممة لدعم نموك الرقمي.",
        resource_card1_title: "التوثيق",
        resource_card1_desc: "أدلة شاملة وتوثيق تقني لخدماتنا وحلولنا.",
        resource_view_btn: "عرض التوثيق",
        resource_card2_title: "المدونة والرؤى",
        resource_card2_desc: "ابق على اطلاع بأحدث الاتجاهات والنصائح والرؤى من فريق خبرائنا.",
        resource_read_btn: "اقرأ المدونة",
        resource_card3_title: "دروس الفيديو",
        resource_card3_desc: "شاهد دروس فيديو خطوة بخطوة وندوات عبر الإنترنت حول مواضيع مختلفة.",
        resource_watch_btn: "شاهد الفيديوهات",
        ...
        resource_card5_desc: "ابحث عن إجابات للأسئلة المتداولة حول خدماتنا.",
        resource_faq_btn: "عرض الأسئلة الشائعة",
        resource_card6_title: "أدوات المطورين",
        resource_card6_desc: "الوصول إلى واجهات برمجة التطبيقات ومجموعات تطوير البرامج وأدوات المطورين لدمج حلولنا.",
        resource_tools_btn: "استكشف الأدوات",

        // Explore Page
        explore_banner_title: "استكشف",
        explore_banner_desc: "اكتشف رحلتنا ومهمتنا ورؤيتنا",
        explore_intro_title: "نافابهاراث تكنولوجيز - تمكين النمو من خلال حلول تقنية المعلومات الذكية",
        explore_intro_desc: "نافابهاراث تكنولوجيز هي شركة حلول تقنية معلومات تفكر في المستقبل تقدم خدمات رقمية ذكية وقابلة للتوسع وموجهة نحو النتائج. مع التركيز القوي على الابتكار والتصميم الذي يركز على العملاء، نساعد الشركات على التحول والأتمتة والنمو في عالم اليوم الرقمي سريع التطور.",
        explore_what_do_title: "ما نفعله",
        explore_what_do_1: "بناء مواقع ويب وتطبيقات ومنتجات رقمية مخصصة مصممة للأداء طويل الأجل.",
        explore_what_do_2: "استراتيجيات وتقنيات ذكية تتناسب مع أهدافك وسير عملك.",
        explore_what_do_3: "أنظمة رقمية قوية وموثوقة ومحسنة لأقصى قدر من الكفاءة.",
        explore_what_do_4: "حلول مصممة مع مراعاة سهولة الاستخدام والتجربة وتأثير الأعمال.",
        explore_mission_title: "مهمتنا",
        explore_mission_p1: "مهمتنا هي تمكين الشركات بحلول رقمية متقدمة تسرع النمو وتعزز ميزتها التنافسية. نحن نركز على تحسين الكفاءة التشغيلية من خلال تقنيات ذكية وآلية وقابلة للتوسع تبسط كل سير عمل.",
        explore_vision_title: "رؤيتنا",
        explore_vision_p1: "رؤيتنا هي أن نكون رائدين عالميين في التحول الرقمي، معترف بنا لقدرتنا على تحويل التحديات المعقدة إلى حلول تكنولوجية بسيطة وفعالة.",
        explore_values_title: "ما نفعله",
        explore_what_we_do_p1: "نحن متخصصون في مجموعة واسعة من خدمات تقنية المعلومات المصممة لتلبية الاحتياجات المتنوعة للمؤسسات الحديثة.",
        explore_trust_title: "لماذا تثق الشركات بنا",
        explore_trust_1_title: "1. نهج مدفوع بالابتكار",
        explore_trust_1_desc: "نستخدم أدوات حديثة وأفضل الممارسات لتقديم حلول جاهزة للمستقبل.",
        explore_trust_2_title: "2. تنفيذ يركز على العملاء",
        explore_trust_2_desc: "كل مشروع مخصص لأهداف عملك وسير عملك.",
        explore_trust_3_title: "3. محترفون ماهرون",
        explore_trust_3_desc: "فريق يجمع بين الإبداع والخبرة والمعرفة الصناعية.",
        explore_trust_4_title: "4. الجودة والشفافية",
        explore_trust_4_desc: "تواصل واضح وعمليات موثوقة وتسليم في الوقت المناسب في كل مرحلة.",

        // Blog Page
        blog_banner_title: "مدونتنا",
        blog_banner_desc: "رؤى وتحديثات وآراء خبراء من عالم التكنولوجيا.",
        blog_post1_title: "روبوتات الدردشة مقابل الدعم البشري: ما هو الأفضل لعملك؟",
        blog_post1_excerpt: "استكشف كيف تعيد روبوتات الدردشة والدعم البشري تشكيل خدمة العملاء واكتشف أي نهج يعمل بشكل أفضل لعملك.",
        blog_post2_title: "أفضل ممارسات الأمان السحابي الأساسية",
        blog_post2_excerpt: "مع انتقال الشركات إلى السحابة، يعد الأمان أمرًا بالغ الأهمية. تعرف على أفضل الاستراتيجيات لحماية أصولك الرقمية وبياناتك.",
        blog_post3_title: "أهم اتجاهات تطوير الويب لعام 2026",
        blog_post3_excerpt: "ابق في الطليعة مع تحليلنا للاتجاهات الناشئة التي ستشكل الإنترنت في العام المقبل.",
        read_more: "اقرأ المزيد",

        // Privacy Policy Page
        privacy_title: "سياسة الخصوصية",
        privacy_sec1_title: "1. المعلومات التي نجمعها",
        privacy_sec1_strong1: "مباشرة من المستخدمين:",
        privacy_sec1_p1: "الاسم والبريد الإلكتروني ورقم الهاتف واسم الشركة ومحتوى الرسالة المقدمة عبر نموذج 'اتصل بنا'.",
        privacy_sec1_strong2: "يتم جمعها تلقائيًا:",
        privacy_sec1_p2: "عنوان IP ونوع المتصفح ونظام التشغيل والصفحات التي تمت زيارتها والوقت المستغرق في الموقع (عبر ملفات تعريف الارتباط/التحليلات).",
        privacy_sec2_title: "2. كيف نستخدم المعلومات",
        privacy_sec2_li1: "للرد على الاستفسارات (الاستخدام الأساسي لبيانات نموذج الاتصال).",
        privacy_sec2_li2: "لتحسين الموقع وجهود التسويق.",
        privacy_sec2_li3: "لحفظ السجلات الداخلية والفواتير المتعلقة بالخدمات المقدمة.",
        privacy_sec3_title: "3. مشاركة البيانات والإفصاح عنها",
        privacy_sec3_strong1: "مقدمو الخدمة:",
        privacy_sec3_p1: "قد نشارك البيانات مع بائعين خارجيين (مثل مزودي الاستضافة وبرامج CRM وGoogle Analytics) الذين يعالجون البيانات نيابة عنا.",
        privacy_sec3_strong2: "الامتثال القانوني:",
        privacy_sec3_p2: "قد نكشف عن المعلومات إذا كان ذلك مطلوبًا بموجب القانون أو أمر المحكمة أو طلب حكومي.",
        privacy_sec4_title: "4. الاحتفاظ بالبيانات",
        privacy_sec4_p1: "نحتفظ باستفسارات الاتصال لفترة محددة (على سبيل المثال، سنتان) وبيانات العميل طوال مدة العقد بالإضافة إلى فترة احتفاظ قياسية (على سبيل المثال، 5 سنوات) لأغراض قانونية وضريبية.",
        privacy_sec5_title: "5. ملفات تعريف الارتباط والتتبع",
        privacy_sec5_p1: "نستخدم ملفات تعريف الارتباط (على سبيل المثال، الوظيفية والتحليلية) لتحسين تجربتك. يمكنك اختيار تعطيل ملفات تعريف الارتباط من خلال خيارات المتصفح الفردية الخاصة بك.",
        privacy_sec6_title: "6. حقوق المستخدم",
        privacy_sec6_p1: "اعتمادًا على موقعك، قد يكون لديك حقوق مثل الحق في الوصول إلى بياناتك الشخصية أو تصحيحها أو حذفها. يرجى الاتصال بنا لممارسة هذه الحقوق.",
        privacy_sec7_title: "7. الأمان",
        privacy_sec7_p1: "نطبق تدابير أمنية عامة، بما في ذلك الخوادم الآمنة والتشفير، لحماية بياناتك من الوصول غير المصرح به أو التعديل أو الإفصاح.",
        privacy_sec8_title: "8. النقل الدولي",
        privacy_sec8_p1: "إذا كنت تصل إلى خدماتنا من خارج الهند، يرجى العلم أن معلوماتك قد يتم نقلها وتخزينها ومعالجتها في الهند حيث توجد خوادمنا.",
        privacy_sec9_title: "9. معلومات الاتصال",
        privacy_sec9_p1: "إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا على:",

        // Terms Page
        terms_sec1_title: "1. قبول الشروط",
        terms_sec1_p1: "من خلال الوصول إلى الموقع أو الاستفادة من خدماتنا، فإنك توافق على هذه الشروط والأحكام. إذا كنت لا توافق، يرجى عدم استخدام خدماتنا.",
        terms_sec2_title: "2. نطاق الخدمات",
        terms_sec2_p1: "نحن نقدم تطوير الويب وتطوير تطبيقات الجوال وتصميم واجهة المستخدم/تجربة المستخدم وخدمات تقنية المعلومات ذات الصلة.",
        terms_sec3_title: "3. ملكية الملكية الفكرية",
        terms_sec3_strong1: "ملكية العميل الفكرية:",
        terms_sec3_p1: "جميع التسليمات النهائية (الكود وملفات التصميم والمحتوى) مملوكة للعميل عند الدفع النهائي.",
        terms_sec3_strong2: "ملكية الوكالة الفكرية:",
        terms_sec3_p2: "تحتفظ نافابهاراث تكنولوجيز بملكية أي أدوات موجودة مسبقًا أو مكتبات كود خاصة أو برامج/منهجيات عامة مستخدمة لإنشاء التسليمات.",
        terms_sec4_title: "4. مسؤوليات العميل",
        terms_sec4_p1: "يجب على العميل توفير المحتوى في الوقت المناسب والوصول الضروري إلى الأنظمة والتعليقات الفورية.",
        terms_sec5_title: "5. شروط الدفع",
        terms_sec5_li1: "الفواتير: سيتم تحديد متطلبات الإيداع المحددة (على سبيل المثال، 50٪ مقدمًا) ومعالم الدفع في بيان العمل.",
        terms_sec5_li2: "الرسوم المتأخرة: نحتفظ بالحق في فرض فائدة على المدفوعات المتأخرة.",
        terms_sec5_li3: "المبالغ المستردة/الإلغاءات: الودائع غير قابلة للاسترداد بشكل عام ما لم ينص على خلاف ذلك في الاتفاقية.",
        terms_sec6_title: "6. الضمانات والصيانة",
        terms_sec6_strong1: "فترة إصلاح الأخطاء:",
        terms_sec6_p1: "نحن نقدم فترة ضمان محدودة (على سبيل المثال، 30 أو 60 يومًا بعد الإطلاق) سنقوم خلالها بإصلاح الأخطاء في الكود المسلم مجانًا.",
        terms_sec6_strong2: "الاستثناءات:",
        terms_sec6_p2: "لا يغطي الضمان المشكلات الناجمة عن تعديلات الطرف الثالث أو تغييرات محتوى العميل أو تحديثات البرامج خارج سيطرتنا.",
        terms_sec7_title: "7. حدود المسؤولية",
        terms_sec7_p1: "مسؤوليتنا محدودة بالمبلغ الذي دفعه العميل للخدمة المحددة. نحن لسنا مسؤولين عن خسائر الأعمال التبعية (على سبيل المثال، فقدان الإيرادات) الناتجة عن خطأ أو فشل في الخدمة.",
        terms_sec8_title: "8. الإنهاء",
        terms_sec8_p1: "يجوز لأي من الطرفين إنهاء مشروع أو اتفاقية في ظل ظروف محددة، مثل الخرق الجوهري للعقد أو عدم الدفع أو الإعسار، كما هو مفصل في اتفاقية الخدمة.",
        terms_sec9_title: "9. التعويض",
        terms_sec9_p1: "يوافق العميل على إبراء ذمة نافابهاراث تكنولوجيز من أي مطالبات أو دعاوى قضائية (على سبيل المثال، انتهاك حقوق الطبع والنشر) الناشئة عن المحتوى أو المواد التي قدمها العميل للمشروع.",
        terms_sec10_title: "10. القانون الحاكم",
        terms_sec10_p1: "تخضع هذه الشروط والأحكام وتفسر وفقًا لقوانين ولاية كارناتاكا، الهند.",
        terms_sec11_title: "11. التغييرات على الشروط",
        terms_sec11_p1: "نحتفظ بالحق في تحديث هذه الشروط في أي وقت. سيتم الإشارة إلى تاريخ المراجعة الأخير في هذه الصفحة.",
        ...
        blog_cb_p1: "Customer expectations are rising faster than ever, pushing businesses to rethink how they deliver support. Both chatbots & human agents play powerful roles in shaping overall customer experiences. While automation can handle quick responses, real conversations still rely on emotional intelligence. Choosing the right balance impacts customer satisfaction, response time & operational cost. This article helps you understand where each option shines so you can decide what fits your business best.",
        blog_cb_h2_1: "1. نقاط قوة دعم روبوت الدردشة",
        blog_cb_key_adv: "المزايا الرئيسية",
        blog_cb_h3_1: "استجابات فورية",
        blog_cb_p2: "Chatbots reply within seconds, helping businesses reduce wait times & handle peak hours efficiently.",
        blog_cb_h3_2: "توفر على مدار الساعة طوال أيام الأسبوع",
        blog_cb_p3: "Bots remain active day & night, ensuring customers get basic information, troubleshooting steps & updates anytime.",
        blog_cb_h3_3: "عمليات فعالة من حيث التكلفة",
        blog_cb_p4: "Companies save on hiring & training costs since chatbots can manage repeated queries with consistent accuracy.",
        blog_cb_h3_4: "قابلية التوسع أثناء الطلب المرتفع",
        blog_cb_p5: "A single bot can talk to thousands of customers at once, making it ideal for fast-growing businesses.",
        ...
        blog_cb_p8: "Humans are naturally creative thinkers. They can analyze a customer's issue from multiple angles, ask clarifying questions & suggest flexible solutions tailored to individual needs. This is helpful when problems do not follow a standard script. Personalized responses reassure customers that their situation is unique & is being handled by someone who genuinely cares.",
        blog_cb_h3_8: "3. أفضل للقضايا المعقدة",
        blog_cb_p9: "Some problems require deeper investigation, multiple verification steps or critical judgment. Human agents excel in these situations because they understand context, exceptions & policies better than automated systems. They can coordinate with other departments, interpret unclear information & offer accurate guidance that bots often miss.",
        blog_cb_h3_9: "4. بناء العلاقات",
        blog_cb_p10: "Strong customer relationships are built through real conversations. A friendly agent can turn a negative experience into a positive one by listening actively & showing patience. Over time, this human touch boosts brand loyalty & increases the chances of repeat business. Customers are more likely to trust companies that treat them like humans rather than transactions.",
        blog_cb_h3_10: "5. الفهم الثقافي والفروق اللغوية الدقيقة",
        blog_cb_p11: "Human agents naturally understand tone, slang, regional expressions & cultural sensitivities. This ensures smoother communication & avoids misunderstandings that bots often face. Whether it's adjusting language formality or understanding local behavior patterns, humans can adapt instantly—making the experience more natural & respectful.",
        blog_cb_conclusion_title: "الخلاصة",
        blog_cb_conclusion_p: "Both chatbots & human support offer unique strengths, making them valuable in different situations. Chatbots are perfect for quick replies, repeated questions & cost-efficient operations. Human agents shine when conversations require emotional care, critical thinking or deep problem-solving. Instead of choosing one over the other, most businesses succeed by blending automation with human expertise. This balanced approach creates faster, smarter & more human-centered support experiences for every customer.",
    ...
    kn: {
        ...
        hero_description: "ನವಭಾರತ್ ಟೆಕ್ನಾಲಜೀಸ್ ಮೈಸೂರು ಮೂಲದ ಸಾಫ್ಟ್‌ವೇರ್ ಕಂಪನಿಯಾಗಿದ್ದು, ವ್ಯವಹಾರಗಳು ಡಿಜಿಟಲ್-ಮೊದಲ ಜಗತ್ತಿನಲ್ಲಿ ಹೊಂದಿಕೊಳ್ಳಲು, ಬೆಳೆಯಲು ಮತ್ತು ಸುರಕ್ಷಿತವಾಗಿರಲು ಸಹಾಯ ಮಾಡುತ್ತದೆ.",
        hero_cta: "ಪ್ರಾರಂಭಿಸಿ",
        about_title: "ನಮ್ಮ ಬಗ್ಗೆ",
        about_description: "ನವಭಾರತ್ ಟೆಕ್ನಾಲಜೀಸ್ ನವೀನ ಮತ್ತು ದೃಢವಾದ ಡಿಜಿಟಲ್ ಉತ್ಪನ್ನಗಳನ್ನು ತಲುಪಿಸಲು ಮೀಸಲಾದ ಪ್ರಮುಖ IT ಪರಿಹಾರ ಪೂರೈಕೆದಾರ.",
        ...
        service1_description: "ಕಾರ್ಯಕ್ಷಮತೆ ಮತ್ತು ಸ್ಕೇಲೆಬಿಲಿಟಿಯನ್ನು ಖಾತ್ರಿಪಡಿಸಲು ಆಧುನಿಕ ತಂತ್ರಜ್ಞಾನಗಳೊಂದಿಗೆ ನಿರ್ಮಿಸಲಾದ ಕಸ್ಟಮ್ ವೆಬ್‌ಸೈಟ್‌ಗಳು.",
        service2_title: "ಮೊಬೈಲ್ ಅಪ್ಲಿಕೇಶನ್ ಅಭಿವೃದ್ಧಿ",
        service2_description: "ತಡೆರಹಿತ ಬಳಕೆದಾರ ಅನುಭವಗಳಿಗಾಗಿ ವಿನ್ಯಾಸಗೊಳಿಸಲಾದ ಸ್ಥಳೀಯ ಮತ್ತು ಕ್ರಾಸ್-ಪ್ಲಾಟ್‌ಫಾರ್ಮ್ ಮೊಬೈಲ್ ಅಪ್ಲಿಕೇಶನ್‌ಗಳು.",
        ...
        service6_description: "ಗ್ರಾಹಕ ಸಂವಹನಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತಗೊಳಿಸಲು ಮತ್ತು ಕರೆ ನಿರ್ವಹಣೆಯನ್ನು ಸುಗಮಗೊಳಿಸಲು ಸುಧಾರಿತ ಸಂವಾದಾತ್ಮಕ ಧ್ವನಿ ಪ್ರತಿಕ್ರಿಯೆ ವ್ಯವಸ್ಥೆಗಳು.",
        service7_title: "AI ಪರಿಹಾರಗಳು",
        service7_description: "ಪ್ರಕ್ರಿಯೆಗಳನ್ನು ಸ್ವಯಂಚಾಲಿತಗೊಳಿಸಲು ಅತ್ಯಾಧುನಿಕ ಕೃತಕ ಬುದ್ಧಿಮತ್ತೆ ಮತ್ತು ಯಂತ್ರ ಕಲಿಕೆ ಪರಿಹಾರಗಳು.",
        why_choose_title: "ನವಭಾರತ್ ಟೆಕ್ನಾಲಜೀಸ್ ಅನ್ನು ಏಕೆ ಆರಿಸಬೇಕು?",
        ...
        why_feature2_desc: "ಸುರಕ್ಷಿತ ಮತ್ತು ರಕ್ಷಿತ ಡೇಟಾವನ್ನು ಖಾತ್ರಿಪಡಿಸುವುದು.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateLanguage(lang) {
        ...
        elementsToTranslate.forEach(element => {
            ...
            // Get translation for current language, fallback to English if missing
            let translatedText = translations[lang] && translations[lang][key];
            if (!translatedText && translations['en'] && translations['en'][key]) {
    ...
    if (form) {
        form.addEventListener('submit', async (e) => {
            ...
            // Email Validation Regex (enforces at least 2 characters for the top-level domain)
            ...
            try {
                ...
                const response = await fetch('https://navabharathtechnologies-website-backend.onrender.com/send-email', {
                    method: 'POST',
                    headers: {
    ...
    function performSearch(query) {
        ...
        if (targetPath) {
            ...
            if (targetPath.startsWith('index.html#') && isHomePage) {
                ...
                // Navigate to the target page (ensure absolute path to avoid directory nesting issues)
                window.location.href = '/' + targetPath.replace('index.html', '');
            }
        } else {
    ...
    // Smart Sticky Header Logic & Active Nav Scroll Spy
    ...
    window.addEventListener('scroll', () => {
        if (!ticking) {
            window.requestAnimationFrame(() => {
                ...
                if (!current && currentScrollY < 200) current = 'home';

                const allNavLinks = document.querySelectorAll('.nav-menu nav a');
                allNavLinks.forEach(link => {
                    link.classList.remove('active');
                    const href = link.getAttribute('href');
                    if (href && (href.includes(`#${current}`) || (current === 'home' && href.endsWith('index.html')))) {
